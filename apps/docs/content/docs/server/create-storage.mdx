...
At initialization, `createStorage` validates key options (for example bucket, file constraints, and middleware configuration) before serving requests.
...
- [Endpoints](/docs/server/endpoints/upload-url) for request/response contracts.
